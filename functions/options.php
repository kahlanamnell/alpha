...
"id1" => array(
    ...
    array("name" => "PostId for Featured Posts 1",
            "desc" => "Select the PostId which should be featured as #1 in the Header.",
            "id" => "featured_category_1",
            "std" => "",
            "type" => "text"),

    array("name" => "PostId for Featured Posts 2",
            "desc" => "Select the PostId which should be featured as #1 in the Header.",
            "id" => "featured_category_2",
            "std" => "",
            "type" => "text"),

    array("name" => "PostId for Featured Posts 3",
            "desc" => "Select the PostId which should be featured as #3 in the Header.",
            "id" => "featured_category_3",
            "std" => "",
            "type" => "text"),

    array("name" => "PostId for Featured Posts 4",
            "desc" => "Select the PostId which should be featured as #4 in the Header.",
