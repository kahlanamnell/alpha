		...
		<ul class="wpzoomSocial">
			...
			foreach ($socialProfiles as $item)
			{
				...
				if ($instance[$id] && $instance[$id] != '') {
				    ...
				    echo '<li><a class="'.$id.'" href="'.$instance[$id].'" rel="external,nofollow" title="'.$instance[$iditem].'"><img src="'. get_template_directory_uri() .'/images/icons/'.strtolower($item).'.png" alt="'.$instance[$iditem]. '" />'.$instance[$iditem].'</a></li>'; 
				}
			} 
			?>
  		</ul>
