...
"id1" => array(
    ...
    array("type" => "startsub",
        ...
        array("name"  => "Number of Posts",
              "desc"  => "Default: <strong>5</strong> (pixels).",
              "id"    => "breaking_number",
              "std"   => "5",
              "type"  => "text"),
    ...
    array("name" => "Post ID for Featured Posts 1",
            "desc" => "Select the Post ID which should be featured as #1 in the Header.",
            "id" => "featured_category_1",
            "std" => "",
            "type" => "text"),

    array("name" => "Post ID for Featured Posts 2",
            "desc" => "Select the Post ID which should be featured as #2 in the Header.",
            "id" => "featured_category_2",
            "std" => "",
            "type" => "text"),

    array("name" => "Post ID for Featured Posts 3",
            "desc" => "Select the Post ID which should be featured as #3 in the Header.",
            "id" => "featured_category_3",
            "std" => "",
            "type" => "text"),

    array("name" => "Post ID for Featured Posts 4",
            "desc" => "Select the Post ID which should be featured as #4 in the Header.",
